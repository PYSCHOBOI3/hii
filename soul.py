...
TOKEN = '7685063460:AAGkPdgDV_V0JTCo2kOQUkToeMw2Ik7qlOE'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002411473849
CHANNEL_ID = -1002411473849
error_channel_id = -1002411473849
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:-@Pyschoboi*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :-@Pyschoboi*", parse_mode='Markdown')
